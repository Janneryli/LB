...
var descriptions = [
    "Это Арахис. У нее все нормально с ногами, просто она очень талантливо может сесть на шпагат. ",
...
function saveNewObjModal() {
    ...
    if (/^\d/.test(title)) closeNewObjModal();
    else {
...
document.addEventListener("keydown", function(event) {
    if (event.code === "ArrowRight") showNextDescription();
    else if (event.code === "ArrowLeft") showPreviousDescription();
});
